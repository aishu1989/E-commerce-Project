...
<style>
 #hom { color:#000000; font-size:medium; font-weight:bold; }
 #hom1 { color:#000000; font-size:medium; font-weight:bold; }
...
<body>
<nav class="navbar navbar-light" style="background-color: #98F5FF;">
  <div class="container-fluid" id="link">
    <div class="navbar-header">
      <a class="navbar-brand" href="<c:url value="/"/>" id="hom">Shopping Spree</a>
    </div>
   <ul class="nav navbar-nav">
      ...
      <c:if test="${empty SuccessMessage && role =='ROLE_USER'}">
      <li><a href="<c:url value="/Cart"/>" id="hom">Cart</a></li>
      </c:if>
    </ul> 
    <ul class="nav navbar-nav navbar-right">
        <c:if test="${empty SuccessMessage}">
        <li><a href="<c:url value="/SignUp"/>" id="hom"><span class="glyphicon glyphicon-pencil"></span> Sign Up</a></li>
