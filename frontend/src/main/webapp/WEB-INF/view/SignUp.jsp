...
Password<br>
<input type="password" name="password" pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}" title="should contain atleast one uppercase,one lowercase,one number" required placeholder="Enter password..."><br>
Address<br>
...
Existing User? <a href="<c:url value="/login"/>">Login</a>
</div>
</div>
</div>
</form>
