...
<marquee style="z-index:2;scrollamount="5">Order today get exciting offers </marquee>
<div class="container">
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
      <img src="<c:url value="/resources/images/41.jpg"/>" id="size" alt="deadspace">
    </div>
    
    <div class="item">
      <img src="<c:url value="/resources/images/42.jpg"/>" id="size" alt="deadspace">
    </div>
  </div>
